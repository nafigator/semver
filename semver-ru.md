...
Дополнительные обозначения для пред-релизных и билд-метаданных возможны как
...
1. Пред-релизная версия МОЖЕТ быть обозначена добавлением дефиса и серией
...
НЕ ДОЛЖНЫ начинаться с нуля. Пред-релизные версии имеют более низкий приоритет,
чем соответствующая релизная версия. Пред-релизная версия указывает на то, что
...
разделённых точкой идентификаторов, следующих сразу за патч или пред-релизной
...
версий на мажорную, минорную, патч и пред-релизные идентификаторы. Именно в
...
минорная и патч-версия равны, пред-релизная версия имеет более низкий приоритет,
чем нормальная версия. Пример: 1.0.0-alpha < 1.0.0. Приоритет двух пред-релизных
...
низший приоритет, чем символьные. Больший набор пред-релизных символов имеет
